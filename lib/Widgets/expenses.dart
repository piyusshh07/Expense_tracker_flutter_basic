...
class Expenses extends StatefulWidget{
  ...
  void _openAddExpenseOverlay(){
    showModalBottomSheet(
        isScrollControlled:true,context: context, builder: (ctx)=> NewExpense(onAddexpense: _addExpense));
  }
...
void _RemoveExpense (Expense expense){
  ...
  Widget build(BuildContext context){
    ...
    if(rregisteredExpenses.isNotEmpty){
      maincontent=Column(
        children: [
          Chart(expenses: rregisteredExpenses,),
          Expanded(child: Expenses_list(expenses: rregisteredExpenses,onRemoveExpense: _RemoveExpense,))
        ],
      );
    }
      return Scaffold(
